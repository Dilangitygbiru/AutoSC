...
echo -e " ${NC}====================================================${NC}" | lolcat
echo -e " ${z} Version$NC       ${Blue}=${NC}${YELL} v${versiedition} LTS Rev.1 $cekupdateinfo"
echo -e " ${z} User$NC          ${Blue}=$NC $username $sts"
echo -e " ${z} Expiry script$NC ${Blue}=${green} $certifacate Days$NC "
echo -e " ${NC}====================================================${NC}" | lolcat
echo -e ""
