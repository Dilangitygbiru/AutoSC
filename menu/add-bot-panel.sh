...
data_ip="https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/user/user"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e " ${blue}Channel   : @RIOTtunel                  ${NC}"
    exit 0
    echo -e "${z}────────────────────────────────────────────${NC}"
    sleep 5
    reboot
...
1 | 01)
  clear
  wget https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/kyt.sh && chmod +x kyt.sh && ./kyt.sh
  ;;
2 | 02)
  clear
  hapus-bot
