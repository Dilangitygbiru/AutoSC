...
IZIN=$(curl https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/system/version | grep $versi123)
>/dev/null 2>&1

versiupdate=$(curl https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/system/version)
...
clear
echo -e "${z}┌──────────────────────────────────────────┐\033[0m"
echo -e "             UPDATE SCRIPT RIOT STORE       "
echo -e "${z}└──────────────────────────────────────────┘\033[0m"
echo -e ""
