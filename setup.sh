...
TIMES="10"
CHATID="5869125156"
KEY="6949082751:AAFMfq6kU4ouYFadD-Xw4Q6Fh0Dne5Q8pEQ"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To RIOT TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}RIOT TUNNELING® ${NC}${YELLOW}(${NC} ${green} RIOT STORE ${NC}${YELLOW})${NC}"
echo -e " Recode By RIOT VPN STORE${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
#Repo git
repo="https://raw.githubusercontent.com/Dilangitygbiru/";
#########################
# USERNAME
rm -f /usr/bin/user
...
clear
# REPO    
    instalasi="https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/"
...
"'&reply_markup={"inline_keyboard":[[{"text":"Register IP","url":"https://wa.me/6287738722195"}]]}' 
...
#cd /usr/local/sbin/
#sed -i 's/\r//' quota
wget https://raw.githubusercontent.com/Dilangitygbiru/AutoSC/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
